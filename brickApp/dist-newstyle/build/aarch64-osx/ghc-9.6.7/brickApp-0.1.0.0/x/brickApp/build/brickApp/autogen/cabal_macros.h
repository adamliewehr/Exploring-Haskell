...
/* package brickApp-0.1.0.0 */
#ifndef VERSION_brickApp
#define VERSION_brickApp "0.1.0.0"
#endif /* VERSION_brickApp */
#ifndef MIN_VERSION_brickApp
#define MIN_VERSION_brickApp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_brickApp */
...
#define CURRENT_COMPONENT_ID "brickApp-0.1.0.0-inplace-brickApp"
