...
/* package randomApp-0.1.0.0 */
#ifndef VERSION_randomApp
#define VERSION_randomApp "0.1.0.0"
#endif /* VERSION_randomApp */
#ifndef MIN_VERSION_randomApp
#define MIN_VERSION_randomApp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_randomApp */
...
#define CURRENT_COMPONENT_ID "randomApp-0.1.0.0-inplace-randomApp"
